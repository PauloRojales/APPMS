<html>
   <head>
      ...
      <!-- AdminLTE Skins. We have chosen the skin-blue for this starter
         ...
         -->
      <!-- daterange picker -->
      <link rel="stylesheet" href="plugins/datepicker/css/daterangepicker.css">
   ...
   <body class="hold-transition skin-black sidebar-mini sidebar-collapse">
         ...
         <aside class="main-sidebar">
            ...
            <section class="sidebar">
               ...
               <ul class="sidebar-menu">
                  ...
                  <li class="active"><a href="money_out.php"><i class="fa fa-money"></i><span>Money Out</span></a></li>
         ...
         <div class="content-wrapper">
            ...
            <section class="content">
               <div class="nav-tabs-custom tabs">
                  ...
                  <li class ="active" ><a href="#company_expenses" data-toggle="tab" id="voucherslist">Expenses</a></li>
                  <li><a href="#company_budget" data-toggle="tab" id="companybudget">Company Budget</a></li>
                  <li><a href="#tab_Vouchers" data-toggle="tab" id="Vouchers">Voucher</a></li>
                  <li><a href="#tab_remain_balance" data-toggle="tab" id="rebalance">Balance</a></li>
                  <div class="tab-content">
                     <!--TAB 1-->
                     <div class="tab-pane active" id="company_expenses">
                        <div class="list_of_vouchers"></div>
                     </div>
                     <!--TAB 2-->
                     <div class="tab-pane" id="company_budget">
                        <div class="list_of_budget"></div>
                     </div>
                     <!--TAB 3-->
                     <div class="tab-pane" id="tab_Vouchers">
                        <div class="budget_outflow"></div>
                     </div>
                     <div class="tab-pane" id="tab_remain_balance">
                        <div class="remain_balance"></div>
                     </div>
                  </div>
               </div>
            </section>
      ...
      <!-- date-range-picker -->
      <script src="plugins/datepicker/js/moment.min.js"></script>
      <script src="plugins/datepicker/js/daterangepicker.js"></script>
      <!-- Bootstrap 3.3.6 -->
      <script src="bootstrap/js/bootstrap.min.js"></script>
      <script src="addfile/moneyout_data.js"></script>
