<html>
   ...
   <body class="hold-transition skin-black sidebar-mini sidebar-collapse">
         ...
         <aside class="main-sidebar">
            ...
            <section class="sidebar">
               ...
               <ul class="sidebar-menu">
                  ...
                  <li class="active"><a href="external_customer.php"><i class="fa fa-users"></i><span>External Customers</span></a></li>
                  ...
                  <li><a href="add_product.php"><i class="fa fa-shopping-cart"></i><span>Products</span></a></li>
                  </li>
               </ul>
               </ul>
               <!-- /.sidebar-menu -->
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <ol class="breadcrumb">
                  ...
                  <li class="active">External Customers</li>
               </ol>
            </section>
            <!-- Main content -->
      ...
      <script src="addfile/external_customer_data.js"></script>
      <!-- AdminLTE App -->
