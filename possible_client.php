<html>
   ...
   <body class="hold-transition skin-black sidebar-mini sidebar-collapse">
         ...
         <aside class="main-sidebar">
            ...
            <section class="sidebar">
               ...
               <ul class="sidebar-menu">
                  ...
                  <li class="active"><a href="possible_client.php"><i class="fa fa-users"></i><span>Possible Customers</a></span></li>
         ...
         <div class="content-wrapper">
            ...
            <section class="content-header">
               ...
               <ol class="breadcrumb">
                  ...
                  <li class="active">Possible Customers</li>
               </ol>
            </section>
            <!-- Main content -->
               ...
               <div class="box box-success">
                  <div class="box-header with-border">
                     ...
                     <div class="box-tools pull-right">
                        <a href="" data-toggle="modal" data-target="#PossibleCustomer"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add New Possible Customers </button></a>
                     </div>
                  </div>
                  <div class="box-body">
      ...
      <script src="addfile/possible_customer_data.js"></script>
      <!-- bootstrap datepicker -->
