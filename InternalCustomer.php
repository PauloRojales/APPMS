...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- Optionally, you can add icons to the links -->
          ...
          <li><a href="ExternalCustomer.php"><i class="fa fa-users"></i><span>External Customers</span></a></li>
			  	<li><a href="#"><i class="fa fa-users"></i>Possible Customers</a></li>
          <li><a href="InternalCustomer.php"><i class="fa fa-user"></i>Internal Customers</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><i class="fa fa-user"></i> Dashboard</h1>
      <ol class="breadcrumb">
  ...
  <section class="content">
        <div class="box box-success">
          <div class="box-header with-border">
            <h4 class="box-tittle"><i class="fa fa-users"> </i> Internal Customers</h4>
              <div class="box-tools pull-right">
                  <a href="" data-toggle="modal" data-target="#ViewInternalCustomer"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add New Possible Customers </button></a>
              </div>
          </div>
          <div class="box-body">
          <div class="ViewInternalCustomer"></div>
          </div>
        </div>
    </section>
    <!-- /.content -->
...
<script src="addfile/data2.js"></script>
