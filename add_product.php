<html>
   ...
   <body class="hold-transition skin-black sidebar-mini sidebar-collapse">
         ...
         <aside class="main-sidebar">
            ...
            <section class="sidebar">
               ...
               <ul class="sidebar-menu">
                  ...
                  <li class="active"><a href="add_product.php"><i class="fa fa-shopping-cart"></i><span>Add Product</span></a></li>
                  </li>
               </ul>
               </ul>
               <!-- /.sidebar-menu -->
            ...
            <section class="content">
               <div class="box box-success">
                  <div class="box-header with-border">
                     <h4 class="box-tittle"><i class="fa fa-shopping-cart"> </i> Products </h4>
                     <div class="box-tools pull-right">
                        <a href="" data-toggle="modal" data-target="#add_new_product"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add New Product </button></a>
                     </div>
                  </div>
                  <div class="box-body">
      ...
      <script src="addfile/add_product.js"></script>
      <!-- AdminLTE App -->
